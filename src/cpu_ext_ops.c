...
const ext_instruction_t g_ext_instr[256] = {
    ...
    {"SET 7, (HL)", 16, set_7_hlp},  // 0xfe
    {"SET 7, A", 8, set_7_a},       // 0xff
};

/**
 * Gameboy CPU (LR35902) CB instruction cycles.
