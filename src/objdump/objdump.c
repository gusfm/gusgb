...
const instruction_t instr[256] = {
    ...
    {"cpl", NULL, 1},                // 0x2f
    {"jr nc, ", NULL, 4},            // 0x30
    {"ld sp, 0x", NULL, 3},          // 0x31
    {"ldd (hl), a", NULL, 1},        // 0x32
    {"inc sp", NULL, 1},             // 0x33
    {"inc (hl)", NULL, 1},           // 0x34
    {"dec (hl)", NULL, 1},           // 0x35
    {"ld (hl), 0x", NULL, 2},        // 0x36
    {"scf", NULL, 1},                // 0x37
    {"jr c, ", NULL, 4},             // 0x38
    ...
    {"jp 0x", NULL, 3},              // 0xc3
    {"call nz, 0x", NULL, 3},        // 0xc4
    {"push bc", NULL, 1},            // 0xc5
    {"add a, 0x", NULL, 2},          // 0xc6
    {"rst 0x00", NULL, 1},           // 0xc7
    {"ret z", NULL, 1},              // 0xc8
    {"ret", NULL, 1},                // 0xc9
    {"jp z, 0x", NULL, 3},           // 0xca
    {NULL, NULL, 2},                 // 0xcb
    {"call z, 0x", NULL, 3},         // 0xcc
    {"call 0x", NULL, 3},            // 0xcd
    {"adc a, 0x", NULL, 2},          // 0xce
    {"rst 0x08", NULL, 1},           // 0xcf
    {"ret nc", NULL, 1},             // 0xd0
    {"pop de", NULL, 1},             // 0xd1
    {"jp nc, 0x", NULL, 3},          // 0xd2
    {NULL, NULL, 1},                 // 0xd3
    {"call nc, 0x", NULL, 3},        // 0xd4
    {"push de", NULL, 1},            // 0xd5
    {"sub 0x", NULL, 2},             // 0xd6
    {"rst 0x10", NULL, 1},           // 0xd7
    {"ret c", NULL, 1},              // 0xd8
    {"reti", NULL, 1},               // 0xd9
    {"jp c, 0x", NULL, 3},           // 0xda
    {NULL, NULL, 1},                 // 0xdb
    {"call c, 0x", NULL, 3},         // 0xdc
    {NULL, NULL, 1},                 // 0xdd
    {"sbc a, 0x", NULL, 2},          // 0xde
    {"rst 0x18", NULL, 1},           // 0xdf
    {"ld (0xff00 + 0x", "), a", 2},  // 0xe0
    {"pop hl", NULL, 1},             // 0xe1
    {"ld (0xff00 + c), a", NULL, 1}, // 0xe2
    {NULL, NULL, 1},                 // 0xe3
    {NULL, NULL, 1},                 // 0xe4
    {"push hl", NULL, 1},            // 0xe5
    {"and 0x", NULL, 2},             // 0xe6
    {"rst 0x20", NULL, 1},           // 0xe7
    {"add sp,0x", NULL, 2},          // 0xe8
    {"jp (hl)", NULL, 1},            // 0xe9
    {"ld (0x", "), a", 3},           // 0xea
    {NULL, NULL, 1},                 // 0xeb
    {NULL, NULL, 1},                 // 0xec
    {NULL, NULL, 1},                 // 0xed
    {"xor 0x", NULL, 2},             // 0xee
    {"rst 0x28", NULL, 1},           // 0xef
    {"ld a, (0xff00 + 0x", ")", 2},  // 0xf0
    {"pop af", NULL, 1},             // 0xf1
    {"ld a, (0xff00 + c)", NULL, 1}, // 0xf2
    {"di", NULL, 1},                 // 0xf3
    {NULL, NULL, 1},                 // 0xf4
    {"push af", NULL, 1},            // 0xf5
    {"or 0x", NULL, 2},              // 0xf6
    {"rst 0x30", NULL, 1},           // 0xf7
    {"ld hl, sp + ", NULL, 4},       // 0xf8
...
static void objdump_instruction(objdump_t *obj, size_t pc)
{
    ...
    if (instr_length == 1) {
        ...
        int8_t operand = obj->rom[pc];
        fprintf(obj->output, "%s%hhd%s\n", asm1, operand, asm2);
    } else {
...
static void objdump_dump(objdump_t *obj)
{
    ...
    while (pc < obj->rom_size) {
        ...
        uint8_t opcode = obj->rom[pc];
        uint8_t length = instr[opcode].length;
        pc += length == 4 ? 2 : length;
    }
    fclose(obj->output);
}
